...
exports.TripLikeService = void 0;
...
class TripLikeService {
    ...
    execute({ tripCuid, userCuid }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const userLikedTrip = trip.likes.find((likedUser) => likedUser.userCuid === user.cuid);
            let tripUpdated;
            if (userLikedTrip) {
...
exports.TripLikeService = TripLikeService;
//# sourceMappingURL=TripLikeService.js.map